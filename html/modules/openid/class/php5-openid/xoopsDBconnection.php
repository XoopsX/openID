 ...
 * @version $Rev: 263 $
 * @link $URL: https://ajax-discuss.svn.sourceforge.net/svnroot/ajax-discuss/openid/trunk/openid/class/php5-openid/xoopsDBconnection.php $
 */
if (!defined('XOOPS_ROOT_PATH')) {
    exit();
}
require_once XOOPS_ROOT_PATH . '/modules/openid/class/php5-openid/Auth/OpenID/DatabaseConnection.php';
